...
<head>
  ...
  <!-- icons -->
  <link href="public/img/logo-utp-white" rel="icon">
  <link href="public/img/logo-utp-white" rel="icon">
  <!-- Google Fonts -->
  ...
  <link href="public/css/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
  <!-- CSS principal -->
...
<body>
  <header id="header" class="header-fixed">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="index.html#intro" class="scrollto"><img src="public/img/logo.png" alt="" title=""></a>
      </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>UTP</strong>. All Rights Reserved
      </div>
      <div class="credits">
      </div>
    </div>
