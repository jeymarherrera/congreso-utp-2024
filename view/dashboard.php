        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="index.html" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Panel</a>
                    <a href="widget.html" class="nav-item nav-link"><i class="fa fa-calendar me-2"></i>Congresos</a>
                    <a href="form.html" class="nav-item nav-link"><i class="fa fa-calendar me-2"></i>Conferencias</a>
                    <a href="table.html" class="nav-item nav-link"><i class="fa fa-calendar me-2"></i>Eventos</a>
                    <a href="table.html" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Salas</a>
                    <a href="chart.html" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Reportes</a>
                    <a href="table.html" class="nav-item nav-link"><i class="fa fa-file me-2"></i>Certificados</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-user me-2"></i>Usuarios</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="button.html" class="dropdown-item">Administradores</a>
                            <a href="typography.html" class="dropdown-item">Invitados</a>
                        </div>
                    </div>
                </div>
            </nav>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="?op=home">Congreso UTP 2024</a>, All Right Reserved. 
                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                        </br>
                        <a class="border-bottom" href="https://utp.ac.pa/" target="_blank">Universidad Tecnológica de Panamá</a>
                        </div>
                    </div>
                </div>
            </div>
