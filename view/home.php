      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>El IESTEC es un evento científico-tecnológico de gran relevancia en la Región Centroamericana, que tiene como objetivo fomentar la investigación, mediante la cooperación entre diversas universidades e instituciones nacionales e internacionales, en todas las áreas temáticas en que se centra el congreso</p>
          </div>
          <div class="col-lg-3">
            <h3>Lugar</h3>
            <p>Universidad Tecnológica de Panamá, Ciudad de Panamá</p>
          </div>
          <div class="col-lg-3">
            <h3>Fechas</h3>
            <p>Miércoles a Viernes<br>18-20 de Octubre</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="speakers" class="wow fadeInUp">
      <div class="container">
        <div class="section-header">
          ...
          <p>Conoce algunos de nuestros conferencistas invitados</p>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card mb-5 mb-lg-0">
              <div class="card-body">
                <h5 class="card-title text-muted text-uppercase text-center">Estudiantes</h5>
                <h6 class="card-price text-center">$125</h6>
                <hr>
                <ul class="fa-ul">
          ...
          <div class="col-lg-4">
            <div class="card mb-5 mb-lg-0">
              <div class="card-body">
                <h5 class="card-title text-muted text-uppercase text-center">Profesionales</h5>
          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title text-muted text-uppercase text-center">Autores</h5>
              ...
              <ul id="faq-list">
                ...
                <li>
                  ...
                  <div id="faq3" class="collapse" data-parent="#faq-list">
                    <p>
                    Los Participantes sólo podrán inscribirse acorde a su rol de participación en el congreso.
          ...
          <form action="" method="post" role="form" class="contactForm">
            <div class="form-row">
              <div class="form-group col-md-6">
                <input type="text" name="name" class="form-control" id="name" placeholder="Ingrese su nombre" data-rule="minlen:4" data-msg="Por favor ingrese un minimo de 4 caracteres" />
                <div class="validation"></div>
              </div>
              <div class="form-group col-md-6">
                <input type="email" class="form-control" name="email" id="email" placeholder="Ingrese su correo" data-rule="email" data-msg="Ingrese un correo válido" />
                <div class="validation"></div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <textarea class="form-control" name="message" rows="5" data-rule="required" data-msg="Escribenos" placeholder="Mensaje"></textarea>
              <div class="validation"></div>
            </div>
