...
<body>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="?op=permitido">
                        ...
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                            <img src="public/img/utp.svg" alt="homepage" width="50" height="50" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="?op=perfil">
                                <img src="public/img/speakers/user.png" alt="user-img" width="36"
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item pt-2">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="?op=permitido"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="?op=evento"
                                aria-expanded="false">
                                <i class="fa fa-user" aria-hidden="true"></i>
                                <span class="hide-menu">Eventos-Conferencias</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
    ...
    <script src="public/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!--Wave Effects -->
    ...
    <!--chartis chart-->
    <script src="public/plugins/bower_components/chartist/dist/chartist.min.js"></script>
    <script src="public/plugins/bower_components/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
