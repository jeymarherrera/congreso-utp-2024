...
<body>
    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-light rounded h-100 p-4">
            <div class="m-n2">
                <button class="btn btn-primary w-100 m-2" type="button">Generar Reportes</button>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid pt-4 px-4">
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Estadistica de Usuarios Internacionales Registrados</h6>
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Estadisticas del Tipo de Usuario Registrados</h6>
